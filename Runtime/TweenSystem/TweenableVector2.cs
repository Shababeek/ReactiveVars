...
{
    /// <summary>
    /// Tweens a Vector2 toward a target using linear interpolation with optional AnimationCurve easing.
    /// </summary>
    public class TweenableVector2 : ITweenable
    {
        ...
        /// <summary>Creates a TweenableVector2 with the given rate and optional easing curve.</summary>
        public TweenableVector2(VariableTweener tweener, Action<Vector2> onChange = null,
            float rate = 2f, Vector2? value = null, AnimationCurve curve = null)
        {
            _start = _target = _value = value ?? Vector2.zero;
            _rate = rate;
            _curve = curve;
            _t = 0;
            OnChange = onChange;
        ...
        public bool Tween(float scaledDeltaTime)
        {
            ...
            _value = Vector2.Lerp(_start, _target, eval);
